...
@class BCMContact;
@class BCMIncidentCategory;

/**
 * Service responsible for managing <code>BCMIncidentCategory</code>s.
 * @author proxi
 * @version 1.0
 */
@interface BCMIncidentCategoryService : BCMSService
 ...
 *
 * N.B. The placeholder contact object will be removed from local store as result of this operation. 
 * Use returned contact Id to get actual stored contact object.
 *
