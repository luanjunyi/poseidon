...
/*!
 @class BCMSNewIncidentController
 @discussion This class controls the New Incident view.
 ...
 @version 1.1
 */
@interface BCMSNewIncidentController : UIViewController <UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate> {
